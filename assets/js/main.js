...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (fTrack) {
    ...
    const story = document.getElementById("f-story");
    // stories are real markup (line breaks + an italic pull-quote), so they're
    // held in a hidden block and copied across rather than set as plain text
    const storySrc = Array.from(document.querySelectorAll(".f-stories > div"));
